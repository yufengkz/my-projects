/* 影像信息组件 */
<template>
  <div v-if="JSON.stringify(firstTabPaneKeys) !== '{}' || flag" class="imageInfo">
    <el-row>
      <el-col :span="24">
        <div class="tabsLarge">
...
export default {
  ...
  watch: {
    realImageDtos(v) {
      ...
      if (JSON.stringify(this.loanMortgageFiles) !== '{}' || JSON.stringify(this.loanPledgeFiles) !== '{}' || (JSON.stringify(this.personFiles) !== '{}' && Object.keys(this.personFiles).some(item => item !== '')) || JSON.stringify(this.legalFiles) !== '{}') {
        this.flag = true
      }
    }
  },
