    ...
    <div class="scroll-board" :ref="ref">
        ...
        >
            <div
                ...
                :style="` height: ${heights[ri]}px; line-height: ${heights[ri]}px; background-color: ${
...
import { deepClone, deepMerge } from '../../utils/utils'
...
export default {
    ...
    methods: {
        ...
        mergeConfig() {
            ...
            this.mergedConfig = deepMerge(deepClone(this.defaultConfig), this.config || {})
        },
        calcHeaderData() {
