<template>
  <el-scrollbar wrap-class="scrollbar-wrapper">
    ...
    >
      <div v-show="!isCollapse" style="height: 88px;border-bottom: solid 1px #48586C;box-sizing: content-box;">
        <img src="" style="padding:22px 0px 0px 32px;height:48px;" alt="Sinochem Capital LOGO" />
      </div>
      <div v-show="isCollapse" style="height: 88px;border-bottom: solid 1px #48586C;box-sizing: content-box;">
