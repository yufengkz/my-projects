...
export function uploadFile() {
  return process.env.VUE_APP_BASE_API + '/ifpc/v1/api/fileCommon/uploadFile'
}
...
export function getFilePath(params) {
  return get('/ifpc/v1/api/fileCommon/downloadFileByObsKey', params)
}
...
export function getFilePathFromCloud(params) {
  return get('/ifpc/v1/api/fileCommon/downloadFileByCloudContractId', params)
}
