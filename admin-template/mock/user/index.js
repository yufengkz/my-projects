...
module.exports = [
  // 获取图形验证码
  {
    url: '/ifpc/v1/api/login/img-verify-code',
    type: 'get',
    response: _config => {
      return {
        isOk: true,
        code: 200,
        message: '/ifpc/v1/api/login/img-verify-code',
        data: {
          imgBase64:
  ...
  // 表格数据
  {
    url: '/ifpc/v1/api/whiteList/list',
    type: 'get',
    response: _config => {
      return {
        code: 200,
  ...
  // 图片浏览
  {
    url: '/ifpc/v1/api/fileCommon/downloadFileByObsKey',
    type: 'get',
    response: _config => {
      return {
        'isOk': true,
        'code': 200,
        'message': '成功',
        'data': 'https://gss0.baidu.com/9fo3dSag_xI4khGko9WTAnF6hhy/zhidao/wh%3D600%2C800/sign=994221d4a58b87d65017a31937380400/a5c27d1ed21b0ef4318b0bbbd9c451da80cb3ef7.jpg'
      }
    }
  },
    ...
    response: _config => {
      return {
        ...
        'data': {
          ...
          'cardFacadeFile': 'https://gss0.baidu.com/9fo3dSag_xI4khGko9WTAnF6hhy/zhidao/wh%3D600%2C800/sign=994221d4a58b87d65017a31937380400/a5c27d1ed21b0ef4318b0bbbd9c451da80cb3ef7.jpg',
          'cardFacadeFileObsKey': 'sit/e4e145239ece4969adaec6ff43fb5729.jpg',
          'cardBackFile': 'https://gss0.baidu.com/9fo3dSag_xI4khGko9WTAnF6hhy/zhidao/wh%3D600%2C800/sign=994221d4a58b87d65017a31937380400/a5c27d1ed21b0ef4318b0bbbd9c451da80cb3ef7.jpg',
          ...
          'faceStatus': 'Y',
          'faceStatusName': '通过',
          'file': 'https://gss0.baidu.com/9fo3dSag_xI4khGko9WTAnF6hhy/zhidao/wh%3D600%2C800/sign=994221d4a58b87d65017a31937380400/a5c27d1ed21b0ef4318b0bbbd9c451da80cb3ef7.jpg',
          ...
          'companyAuthOutDTOList': [
            {
              ...
              'companyFile': 'https://gss0.baidu.com/9fo3dSag_xI4khGko9WTAnF6hhy/zhidao/wh%3D600%2C800/sign=994221d4a58b87d65017a31937380400/a5c27d1ed21b0ef4318b0bbbd9c451da80cb3ef7.jpg',
  ...
  // 穿梭框 mock数据
  {
    url: '/ifpc/v1/api/mock/Transfer',
    type: 'get',
    response: _config => {
      return { 'isOk': true, 'status': 200, 'code': '', 'message': '成功', 'data': [{ 'id': 114, 'ownerId': 'C526175427283267584', 'ownerName': '蛋白', 'ownerRole': '3', 'ownerRole$FICDictName': '担保人', 'oneLevelType': 'unmovable', 'oneLevelType$FICDictName': '不动产抵押', 'twoLevelType': 'house', 'twoLevelType$FICDictName': '房产', 'threeLevelType': 'live_house', 'threeLevelType$FICDictName': '居住房产', 'fourLevelType': 'normal_house', 'fourLevelType$FICDictName': '普通住宅', 'fourLevelTypeOther': null, 'warrantNo': '12', 'address': '14,1403,140302', 'addressName': '山西省阳泉市城区', 'detailAddress': '山西', 'area': '12', 'identifyValue': '12', 'identifyOrgan': '12', 'identifiedValue': null, 'hasLease': 'Y', 'hasLease$FICDictName': '是', 'leaseTermStart': '2020-12-29 00:00:00', 'leaseTermEnd': '2021-01-19 00:00:00', 'rent': '1212', 'otherCertificateNo': '12', 'buyTime': null, 'buyPrice': null, 'number': null, 'quality': null, 'unitPrice': null, 'contractingStart': null, 'contractingEnd': null, 'annualRent': null, 'treeSpecies': null, 'treeAge': null, 'status': null, 'createBy': '143', 'createTime': null, 'updatedBy': '143', 'updatedTime': null, 'majorGuarantee': null, 'approveRiskValue': null, 'pledgeType': '0' }] }
    }
  },

  // 可编辑表格数据
  {
    url: '/ifpc/v1/api/editTable/list',
    type: 'get',
    response: _config => {
      return {
        code: 200,
