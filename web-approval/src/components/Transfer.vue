    ...
    >
      ...
      <template slot-scope="scope">
        <el-row v-for="(item,index) in scope" :key="index" class="p_father">
          <el-col class="p_son">
            <el-col class="p_b" style="color:#333;">{{item.oneLevelType$FICDictName}}-{{item.twoLevelType$FICDictName}}-{{item.threeLevelType$FICDictName}}</el-col>
            <el-col class="p_b" style="color:#bcbcbc;">地址:{{item.addressName}}{{item.detailAddress}}</el-col>
