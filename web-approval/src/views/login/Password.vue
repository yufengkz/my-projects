        ...
        <el-card>
          ...
          <el-form :model="form" status-icon ref="form" :rules="rules" label-width="30%" v-show="step === 1">
            ...
            <el-form-item label="短信验证码" prop="smsVerifyCode" scope-slot="error">
              <el-input v-model="form.smsVerifyCode" autocomplete="off" placeholder="请输入短信验证码" maxlength="6">
          ...
          <!-- 修改密码 -->
          <el-form :model="pwdForm" status-icon ref="pwdForm" :rules="pwdFormRules" label-width="30%" v-show="step === 2">
            <el-form-item label="旧密码" prop="password">
              <el-input type="password" v-model="pwdForm.password" autocomplete="off" placeholder="请输入旧密码"></el-input>
            </el-form-item>
            <el-form-item label="新密码" prop="newPassword">
              <el-input type="password" v-model="pwdForm.newPassword" autocomplete="off" placeholder="请输入新密码"></el-input>
            </el-form-item>
            <div class="btns-center-box">
              <el-button @click="goBack">返回</el-button>
...
<script>
import { getImgCode, checkImgCode, sendSmsCode, updatePasswordStepOne, updatePasswordStepTwo } from '@/api/login.js'
  ...
  methods: {
    ...
    submitForm(formName) {
      this.$refs[formName].validate(valid => {
        if (valid) {
          updatePasswordStepTwo({
            mobileNo: this.form.mobileNo,
            oldPassword: Base64.encode(this.pwdForm.password),
            newPassword: Base64.encode(this.pwdForm.newPassword),
