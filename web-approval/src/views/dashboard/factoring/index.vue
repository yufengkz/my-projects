    ...
    <el-card class="user-data-card">
      ...
      <div class="box-content">
        ...
        <div class="item">
          ...
          <span class="text-content">收到融资申请笔数（笔）
            <br>
            <span style="font-size: 26px;color:#465062">
        ...
        <div class="item">
          ...
          <span class="text-content">放款金额（元）
            <br>
            <span style="font-size: 26px;color:#465062">
        ...
        <div class="item">
          ...
          <span class="text-content">放款笔数（笔）
            <br>
            <span style="font-size: 26px;color:#465062">
...
export default {
  ...
  methods: {
    ...
    getPieData() {
      // mock data
      // this.pieChartData = {
      //   legend: ['财产一切险', '机器损坏险', '公众责任险', '公司A', '公司B', '公司C'],
      //   series: [{ value: 320, name: '财产一切险' }, { value: 240, name: '机器损坏险' }, { value: 149, name: '公众责任险' }, { value: 100, name: '公司A' }, { value: 100, name: '公司B' }, { value: 100, name: '公司C' }]
      // }
