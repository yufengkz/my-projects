...
<template>
  <div class="guarantorInfo">
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <template v-for="(item, index) in familyPropertyTabData">
...
export default {
  ...
  mounted() {
    this.activeName = this.familyPropertyTabData[0] && this.familyPropertyTabData[0].name
  },
  methods: {
