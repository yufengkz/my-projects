...
module.exports = {
  ...
  devServer: {
    ...
    proxy: {
      ...
      '/api/common': {
        target: 'http://10.145.5.51:32274/', // 小贷审批系统开发服务器
        pathRewrite: {
          '^/api/common': '/common'
        }
      },
      '/api/approve': {
        target: 'http://10.145.5.51:32274/', // 小贷审批系统开发服务器
        // target: 'http://10.145.5.25:30787/', // 小贷审批系统开发服务器
        // target: 'http://10.10.30.131:8083/', // che
        // target: 'http://10.10.30.253:8083/', // 吴振昊
        // target: 'http://10.10.30.81:8083/', // 李玉洲
        // target: 'http://10.10.30.95:8083/', // 翟倩
        // target: 'http://10.10.30.23:8083/', // 超哥
        pathRewrite: {
          '^/api/approve': '/approve'
        }
      }
