...
<template>
  <div class="container">
    ...
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" size="mini" label-position="right" label-width="130px">
      <!-- 中心信息 -->
      <v-form :title="+type === 0 ? '新增担保公司' : '修改担保公司'">
          ...
          <el-row :gutter="40">
            ...
            <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
              <el-form-item prop="creditCode" label="统一社会信用代码">
                <el-input v-model="ruleForm.creditCode" placeholder="请输入" maxlength="18"></el-input>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        rate: [
          { required: true, message: '请输入合作利率', trigger: 'blur' },
          { pattern: money, message: '请输入正确的合作利率', trigger: 'blur' }
        ],
