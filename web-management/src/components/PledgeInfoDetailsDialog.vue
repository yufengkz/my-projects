      ...
      <div class="content-container">
        <div class="m-t-20" v-if="outCheckSource.twoLevelType === 'receivable_account'">
          ...
          <DescriptionList :content="outCheckSource" class="m-t-20 m-l-20">
            ...
            <Description label="约定期限">
              {{ outCheckSource.accountStart | formatDate('yyyy-MM-dd') }}至{{ outCheckSource.accountEnd | formatDate('yyyy-MM-dd') }}
            </Description>
...
<script>
import { getGuaranteePledgeFileList } from '@/api/business'
